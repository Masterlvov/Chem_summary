...
- 
- 大电池快充倍率赋值问题：在XFC时，存在温升分布以及电流密度不均问题，进而soc分布也不均。C-rate =f(T,soc),在电芯大面上，温度高的地方SOC高，温度低的地方soc低，若按照温度低的NTC温度值和平均soc计算，则赋值的倍率低于实际能力；反之，按照温度高的NTC温度值和平均soc计算，则超出能力边界，必然析锂。如何指定策略是个好问题。
